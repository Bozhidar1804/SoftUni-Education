...
namespace TravelAgency.Data
{
    ...
    {
        private const string connectionString = @"Server=DESKTOP-FI5CDKM\SQLEXPRESS;Database=TravelAgency;Integrated Security=True;Encrypt=False";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder
                ...
                .HasKey(pg => new { pg.TourPackageId, pg.GuideId });
